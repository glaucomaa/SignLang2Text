...
rgb_front_clips()
{
	...
	gdown --id 16jgh79GCIuLSBHthh__HN-rYxHDsPR8C -O train_rgb_front_clips.zip

	## Val
	### val_rgb_front_clips.zip
	gdown --id 1DhLH8tIBn9HsTzUJUfsEOGcP4l9EvOiO -O val_rgb_front_clips.zip


	## Test
	### test_rgb_front_clips.zip
	gdown --id 1qTIXFsu8M55HrCiaGv7vZ7GkdB3ubjaG -O test_rgb_front_clips.zip
